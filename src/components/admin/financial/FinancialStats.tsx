...
const FinancialStats: React.FC<FinancialStatsProps> = ({ isVisible, onToggle, initialBalance, income, expenses, currentBalance }) => {
  ...
  return (
    <div className="relative">
      ...
      <button onClick={onToggle} className="absolute -bottom-4 left-1/2 -translate-x-1/2 w-8 h-8 rounded-full bg-blue-600 text-white shadow-lg flex items-center justify-center hover:bg-blue-700 transition-all z-40 border-2 border-white">
